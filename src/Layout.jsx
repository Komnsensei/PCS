    ...
    <div style={{ background: "var(--bg-void)", minHeight: "100vh" }}>
      ...
      >
        <Link to={createPageUrl("Square")} className="flex items-center gap-2 hover:opacity-90 transition-opacity">
          <img src="https://qtrypzzcjebvfcihiynt.supabase.co/storage/v1/object/public/base44-prod/public/699fda3968041d3acd697665/eb9aaffda_pc.png" alt="Passioncraft" className="h-7 w-auto" />
        </Link>
