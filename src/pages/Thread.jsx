        ...
        <div className="card-void p-6 mb-6">
          <div className="flex items-start justify-between gap-3 mb-4 flex-wrap">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {thread.rosary_vow_accepted && (
                <span className="text-xs text-[var(--text-muted)] italic">🔮 rosary vow</span>
              )}
            </div>
            <div className="flex items-center gap-2">
              {totalPrestige > 0 && (
                <span className="text-xs text-[#a594f9] font-medium">✦ {totalPrestige} prestige</span>
              )}
          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            ...
            <span className="text-xs text-[var(--text-muted)]">
              ...
              {thread.seeking !== "any" && <> · seeking <span style={{ color: thread.seeking === "bio" ? "#4ade9a" : "#60c0f0" }}>{thread.seeking}</span></>}
            </span>
          </div>
        </div>
